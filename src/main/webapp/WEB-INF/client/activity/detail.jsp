...
<div>
    ...
    <table>
        ...
        <tr><td><a href="/client/moreDetailPage.action?activityId=${activity.id}">查看详情-></a></td></tr>
    </table>
</div>
<div>
    <form action="/client/participatePage.action?activityId=${activity.id}">
        <input name="participate" type="submit" value="我要参加"/>
    </form>
</div>
<div>
<label>已报名的人</label><br>
    <table>
        <c:forEach items="${activity.participators}" var="participator" varStatus="rowStatus">
            <a href="/client/participatorDetail.action?participatorId=${participator.id}"><button>
